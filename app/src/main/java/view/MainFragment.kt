...
class MainFragment : Fragment() {
    ...
    private fun setData(weatherData: Weather) {
        ...
        binding.tvTemp.text = weatherData.temperature.toString()
        binding.tvFeelTemperatureField.text = weatherData.feelsLike.toString()
        binding.tvConditionTextView.text = weatherData.cloudy
    }
